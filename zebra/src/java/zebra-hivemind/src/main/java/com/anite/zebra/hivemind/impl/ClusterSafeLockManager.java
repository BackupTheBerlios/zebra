...
public class ClusterSafeLockManager implements LockManager {
	...
	private final static Log log = LogFactory
			.getLog(ClusterSafeLockManager.class);
	...
	public void aquireLock(IProcessInstance processInstance, Session session)
		...
		while (!isLocked) {
			DatabaseLock lock;
			try {
				lock = (DatabaseLock) session.get(DatabaseLock.class,
	 ...
	 * @throws LockException
	 */
	public void releaseLock(IProcessInstance processInstance, Session session)
			throws LockException {
